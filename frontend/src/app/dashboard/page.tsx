    ...
    <div className="page-container animate-fade-in-up" style={{ animationFillMode: "both" }}>
      ...
      <div className="mb-10">
        ...
        <p className="text-[15px] text-txt-muted">
          Bem-vindo ao <strong className="text-txt-secondary">Mecâni.cão PCM</strong>. Acompanhe a saúde dos seus ativos industriais.
        </p>
      </div>
      ...
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-5 mb-10">
        {[
          ...
          <div key={kpi.label} className="glass-card p-space-lg" style={{ borderRadius: "14px" }}>
            ...
            <p className="text-[11px] mt-1 text-txt-muted" style={{ opacity: 0.85 }}>{kpi.sub}</p>
          </div>
        ))}
      </div>
        ...
        <div className="lg:col-span-1 glass-card p-space-lg" style={{ borderRadius: "14px" }}>
          ...
          <div className="space-y-3">
            {[
              ...
              { label: "Ordens de Manutenção", sub: "Emita e acompanhe as OMs da planta", href: "/ordens-manutencao", color: "#E8842C", iconPath: "M9 5H7a2 2 0 0 0-2 2v12a2 2 0 0 0 2 2h10a2 2 0 0 0 2-2V7a2 2 0 0 0-2-2h-2M9 5a2 2 0 0 0 2 2h2a2 2 0 0 0 2-2M9 5a2 2 0 0 1 2-2h2a2 2 0 0 1 2 2m-6 9 2 2 4-4" },
            ].map(link => (
          ...
          <div>
            ...
            <div className="grid grid-cols-2 gap-3">
              {[
                ...
                { label: "Estoque de Peças", desc: "Controle de materiais" },
              ].map(mod => (
                <div key={mod.label} className="info-sub-card flex items-start gap-3">
